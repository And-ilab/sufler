...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    body:
      '☰ — меню АРМ · Esc — закрыть меню/модалки или отменить голосовую запись · Enter — отправить ответ клиенту · Shift+Enter — новая строка · Пробел — голосовой ввод (ещё раз — стоп) · Ctrl+K — шаблоны.',
  },
]
