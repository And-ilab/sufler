...
from online_chat.views import (
    ...
    dialog_topic_detail,
    dialog_topics_collection,
    dialog_topics_reorder,
    dialog_topics_suggest,
    dialog_transfer,
    dialogs_collection,
    department_detail,
...
urlpatterns = [
    ...
    path("dialog-topics/", dialog_topics_collection, name="online_chat_dialog_topics"),
    path("dialog-topics/<uuid:item_id>/", dialog_topic_detail, name="online_chat_dialog_topic"),
    path("dialog-topics/reorder/", dialog_topics_reorder, name="online_chat_dialog_topics_reorder"),
    path("dialog-topics/suggest/", dialog_topics_suggest, name="online_chat_dialog_topics_suggest"),
