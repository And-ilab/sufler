...
## Инфраструктура (VII.3)

[Требования к серверу / ВМ](../../technical/server-requirements.md) — спецификация Исполнителя для тестового и целевого контуров (CPU/RAM/GPU/ОС, сеть, интеграции).
